...
const char ssid[] = "Starlink Familia Martinez";
//Contraseña de la red Wifi
const char pass[] = "andresdc2013";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "jn.cordobap1"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "jn.cordobap1"; 
//Contraseña de MQTT que recibió por correos
const char MQTT_PASS[] = "202422615";
const char MQTT_SUB_TOPIC[] = HOSTNAME "/";
//Tópico al que se enviarán los datos de humedad
const char MQTT_PUB_TOPIC1[] = "humedad/cubarral/" HOSTNAME;
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC2[] = "temperatura/cubarral/" HOSTNAME;
//Tópico al que se enviarán los datos de luminosidad
const char MQTT_PUB_TOPIC3[] = "luminosidad/cubarral/" HOSTNAME;
...
void loop()
{
  ...
  int luminosidad = analogRead(fotocelda); // GPIO 32
  ...
  String jsonluminosidad = "{\"value\": "+ String(luminosidad) + "}";
  char payload3[jsonluminosidad.length()+1];
  jsonluminosidad.toCharArray(payload3, jsonluminosidad.length()+1);
